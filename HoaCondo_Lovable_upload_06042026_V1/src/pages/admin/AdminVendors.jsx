...
/**
 * AdminVendors — HOACONDInsight™ OS v5.1
 * Hoa Condo Insight LLC · 61 N Lakeshore Drive, Hypoluxo, Florida 33462
 */
export default function AdminVendors() {
  const kpis = [('Vendors', '47', 'All integrations'), ('SOP Validated', '0', 'Awaiting validation'), ('Active', '4', 'Core required'), ('Pending', '43', 'Toggle to activate')];
  ...
  return (
    <div>
      <div style={{ marginBottom:'1.5rem' }}>
        ...
        <p style={{ fontSize:'0.825rem', color:'var(--text-muted)', marginTop:'0.25rem' }}>Vendor management, SOP validation status, and contract tracking.</p>
      </div>
      ...
      <div className="card" style={{ padding:'2rem' }}>
        <div style={{ textAlign:'center', padding:'2.5rem 0', color:'var(--text-muted)' }}>
          ...
          <p style={{ fontWeight:700, color:'var(--navy)', marginBottom:'0.5rem', fontSize:'1rem' }}>Connect Supabase to populate Vendors</p>
          <p style={{ fontSize:'0.825rem', lineHeight:1.75, maxWidth:420, margin:'0 auto' }}>
            All Vendors data is stored in Supabase and displayed here in real time.<br />
